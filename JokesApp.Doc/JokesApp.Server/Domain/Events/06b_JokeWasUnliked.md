# 📘 06b_JokeWasUnliked.md

### *JokeWasUnliked — Domain Event*

Evento di dominio che rappresenta il fatto: **è stato rimosso un like da una barzelletta** (“unlike”).
Registra l’identificatore tipizzato della barzelletta e il nuovo totale dei like dopo l’operazione.

---

## 1) Quando viene emesso

L’Aggregate `Joke` emette `JokeWasUnliked` quando l’operazione di rimozione like va a buon fine e lo stato risultante è coerente.
